package net.valoris.tutorialmod.block;
...
import net.valoris.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block FROZEN_OAK_LOG = registerBlock("frozen_oak_log",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.OAK_LOG).sounds(BlockSoundGroup.GLASS)));
